...
const Navigation = () => {
    ...
    return (
        <>
            ...
            <ul className={`${styles.mainNavigations} ${isActive ? `${styles.active}` : ''}`}>
                <li className={pathname === "/" ? styles.active : ""} onClick={isMobileView ? handleClosed : undefined}><Link href="/">Home</Link></li>
                <li className={pathname === "/about-us" ? styles.active : ""} onClick={isMobileView ? handleClosed : undefined}><Link href="/about-us">About Us</Link></li>
                ...
                <li className={pathname === "/pricing" ? styles.active : ""} onClick={isMobileView ? handleClosed : undefined}><Link href="/pricing">Pricing</Link></li>
                <li className={pathname === "/portfolio" ? styles.active : ""} onClick={isMobileView ? handleClosed : undefined}><Link href="/portfolio">Portfolio</Link></li>
                <li className={pathname === "/blogs" ? styles.active : ""} onClick={isMobileView ? handleClosed : undefined} ><Link href="/blogs">Blog</Link></li>
                <li className={pathname === "/contact-us" ? styles.active : ""} onClick={isMobileView ? handleClosed : undefined}><Link href="/contact-us">Contact Us</Link></li>
            </ul>
            <ul className={`${styles.lastBtn} d-flex d-md-none`}>
