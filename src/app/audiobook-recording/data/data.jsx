//Banner
import BannerPoster from "media/services/audiobook-recording/bannerImg.webp"

export const BannerData = {
    subtitle: "Top- ranked Audiobook Recording company in US",
    title: "Professional Audiobook Recording Services To Give Your Books A Voice!",
    desc: "Audiobooks are becoming increasingly popular in today's digitally-driven world, and we ensure you are always one step ahead in the game with the best audiobook service in the industry!",
...
// Process
import ProcessImage from "media/services/audiobook-recording/ProcessImage.webp"
export const ProcessData = {
    subtitle: "Our Process",
    title: "Storytelling Made Easy With Our Audio Book Recording Services",
    desc: "If you're a book writer, then audiobook production must be on your radar. Even if you're not yet a published author, it's worth learning about the process of turning your words into an audio experience.",
