//Banner
import BannerPoster from "media/services/book-cover-design/bannerImg.webp"
...
// Process
import ProcessImage from "media/services/book-cover-design/ProcessImage.webp"
...
export const InnerServicesData = {
    ...
    innerServItem: [
        ...
        },
        {
            ...
            txt: "We have a fast turnaround time and can deliver your book cover within days if you need it urgently.",
        },
        {
...
//  Content Data
import BannerImage from "media/services/book-cover-design/Img01.webp"
export const ContentData = {
    title: "Professional Book Cover Design Services That Help Your Ideal Readers Judge Your Book By Its Cover!",
    desc: "Call us if you want to get your hands on the beautiful, engaging, and effective book cover to break the competition and make a NAME.",
