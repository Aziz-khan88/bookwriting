//Banner
import BannerPoster from "media/services/ebook-writing/bannerImg.webp"
...
export const BannerData = {
    ...
    desc: "We are the experts of designing, illustrating, and compiling your eBooks for a successful publication.",
...
// Process
import ProcessImage from "media/services/ebook-writing/ProcessImage.webp"
...
export const InnerServicesData = {
    //  column: "yes",
    subtitle: "Why Choose",
    title: "Why Choose Our E-Book Writing Services?",
    desc: "",
    innerServItem: [
        {
            title: (<>World-Class writing-services Team</>),
        ...
        },
        {
            ...
            txt: "Our process begins with extensive publishing strategy sessions to ensure we develop a plan to achieve your goals.",
        },
        {
            title: (<>Refined Process</>),
            txt: "Enjoy the efficiency and dependability of a professionally managed writing-services process.",
        },
        {
            title: (<>Book Writing writers</>),
            txt: "Our team includes #1 New York Times - Book Writing writers and award-winning authors for almost any genre.",
        },
        {
            title: (<>Big-5 Editors</>),
...
//  Content Data
import BannerImage1 from "media/services/ebook-writing/Img02.webp"
...
//  Content Data
import BannerImage from "media/services/ebook-writing/Img01.webp"
export const ContentData = {
    title: "Professional eBook Writing and Publishing We Give New Life To Your Words",
    desc: "Your idea is unique, and you need a company that will take it from start to finish. We are here for all the steps, so your legacy can live in words.",
